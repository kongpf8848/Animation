...
public class CardActivity extends BaseActivity {
    ...
    private static final String[] CHANNELS = new String[]{"打卡", "契约", "消息", "我的"};
    private static final String[] ANIMATIONS = new String[]{"lottie_card_3.json", "lottie_contract_3.json", "lottie_message_3.json", "lottie_my_3.json"};
    ...
    private void initMagicIndicator() {
        ...
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerTitleView getTitleView(Context context, final int index) {
                ...
                View customLayout = LayoutInflater.from(context).inflate(R.layout.item_tab_card, null, false);
