...
class BaseCircleIndicator extends LinearLayout {
    ...
    @Nullable private BaseCircleIndicator.IndicatorCreatedListener mIndicatorCreatedListener;
    ...
    private void bindIndicatorBackground(View view, @DrawableRes int drawableRes, @Nullable ColorStateList tintColor) {
        if (tintColor != null) {
            Drawable indicatorDrawable = DrawableCompat.wrap(ContextCompat.getDrawable(getContext(), drawableRes).mutate());
